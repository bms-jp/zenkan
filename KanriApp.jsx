        ...
        <div className="card-body">
          ...
          <div className="form-grid">
            ...
            <div className="form-field">
              ...
              <select className="form-select" value={form.aiModel||"claude-sonnet-4-6"} onChange={e => setForm({...form, aiModel: e.target.value})}>
                <option value="claude-sonnet-4-6">claude-sonnet-4-6 (推奨・バランス型)</option>
                <option value="claude-opus-4-7">claude-opus-4-7 (高品質・高コスト)</option>
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="banner info" style={{marginBottom:14}}>
            データはブラウザの <strong>IndexedDB</strong>（kanri_v3 データベース）に保存されています。<strong>ブラウザのデータ削除・プライベートモード・ブラウザ変更で消失します</strong>。定期的にJSONバックアップを取得してください。
          </div>
          <div className="kv-grid" style={{marginBottom:14}}>
            <dt>現在使用量</dt><dd className="tabular">{(getStorageUsage(data)/1024).toFixed(1)} KB <span className="muted" style={{fontSize:11}}>（IndexedDB: 通常数百MB〜数GB使用可能）</span></dd>
